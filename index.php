...
$query = "SELECT siswa.*, kelas.nama AS kelas FROM siswa
JOIN kelas_siswa ON kelas_siswa.siswa_id = siswa.id
JOIN kelas ON kelas.id = kelas_siswa.kelas_id";
    ...
    <body>
        ...
        <table border="1">
            ...
            while($siswa_data = mysqli_fetch_array($result)) {
                ...
                echo "<td><a href='hapus_siswa.php>id=$siswa_data[id]'>Delet</a></td>";
            }
            ?>
        </table>
    </body>
